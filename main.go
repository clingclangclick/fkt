...
var CLI struct {
	ConfigFile    string `type:"existingfile" short:"f" help:"YAML configuration file" env:"CONFIG_FILE" default:"${config_file}"`
	...
	Logging       struct {
		Level string `enum:"default,none,trace,debug,info,warn,error" short:"l" help:"Log level" env:"LOG_LEVEL" default:"default"`
		File  string `type:"path" short:"o" help:"Log file" env:"LOG_FILE"`
		Type  string `enum:"default,console,json" short:"t" help:"Log format" env:"LOG_FORMAT" default:"default"`
